...
devices: one row per enrolled key (contract §2.2), plus its SBcred3 when holder_commit was sent and its
calibration (cal_*, pop/calibration.py) when one was sent. sessions: a JSON document per session;
...
CREATE TABLE IF NOT EXISTS devices (
  ...
  cal_us INTEGER, cal_sample_rate INTEGER, cal_route TEXT, cal_backend TEXT, cal_at TEXT, cal_samples TEXT);
...
_DEV_COLS = ["device_id", "pubkey", "display_name", "model", "security_level", "security_level_reported",
             ...
             "cal_us", "cal_sample_rate", "cal_route", "cal_backend", "cal_at", "cal_samples"]
_ADDED = {"platform": "TEXT NOT NULL DEFAULT 'android'", "key_kind": "TEXT", "attest_key_id": "TEXT",
          "holder_commit": "TEXT", "cred": "TEXT", "cred_sig": "TEXT", "cred_expiry": "INTEGER",
          "cal_us": "INTEGER", "cal_sample_rate": "INTEGER", "cal_route": "TEXT", "cal_backend": "TEXT", "cal_at": "TEXT",
          "cal_samples": "TEXT"}
