//! oa2zk (copy of ../../openac/prover sbzk, circuit list changed; `wtns` input path added): prove / verify the sound-bound circom circuits with Spartan2 (ZK, Hyrax PCS on T-256),
...
//!
//! Circuits: oa2_*, oa2t_* (whichever were compiled into ../build/cpp).
//!   oa2zk inspect <circuit> <proof.bin>  SNARK-verify only; print the proof's public values (../../verifier/popzk.py)
...
#[cfg(has_oa2_d1_sig)]
witnesscalc_adapter::witness!(oa2_d1_sig);
#[cfg(has_oa2_d2_sig)]
witnesscalc_adapter::witness!(oa2_d2_sig);
#[cfg(has_oa2_d5_sig)]
witnesscalc_adapter::witness!(oa2_d5_sig);
#[cfg(has_oa2_d1_audio)]
witnesscalc_adapter::witness!(oa2_d1_audio);
#[cfg(has_oa2_d2_audio)]
witnesscalc_adapter::witness!(oa2_d2_audio);
#[cfg(has_oa2_d5_audio)]
witnesscalc_adapter::witness!(oa2_d5_audio);
#[cfg(has_oa2_pair)]
witnesscalc_adapter::witness!(oa2_pair);
#[cfg(has_oa2_d2_sig_w60)]
witnesscalc_adapter::witness!(oa2_d2_sig_w60);
#[cfg(has_oa2t_s48)]
witnesscalc_adapter::witness!(oa2t_s48);
#[cfg(has_oa2t_s44)]
witnesscalc_adapter::witness!(oa2t_s44);
#[cfg(has_oa2t_pair)]
witnesscalc_adapter::witness!(oa2t_pair);

fn witness_bytes(circuit: &str, json: &str) -> Result<Vec<u8>, String> {
    let r: anyhow_like::Res = match circuit {
        #[cfg(has_oa2_d1_sig)]
        "oa2_d1_sig" => oa2_d1_sig_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2_d2_sig)]
        "oa2_d2_sig" => oa2_d2_sig_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2_d5_sig)]
        "oa2_d5_sig" => oa2_d5_sig_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2_d1_audio)]
        "oa2_d1_audio" => oa2_d1_audio_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2_d2_audio)]
        "oa2_d2_audio" => oa2_d2_audio_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2_d5_audio)]
        "oa2_d5_audio" => oa2_d5_audio_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2_pair)]
        "oa2_pair" => oa2_pair_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2_d2_sig_w60)]
        "oa2_d2_sig_w60" => oa2_d2_sig_w60_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2t_s48)]
        "oa2t_s48" => oa2t_s48_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2t_s44)]
        "oa2t_s44" => oa2t_s44_witness(json).map_err(|e| e.to_string()),
        #[cfg(has_oa2t_pair)]
        "oa2t_pair" => oa2t_pair_witness(json).map_err(|e| e.to_string()),
