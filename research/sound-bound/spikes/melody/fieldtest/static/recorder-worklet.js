/* fieldtest recorder (copy of sound-bound/static/recorder-worklet.js).
 ...
 */
class FieldtestRecorder extends AudioWorkletProcessor {
    constructor() {
        super();
        this.stopped = false;
...
registerProcessor('fieldtest-recorder', FieldtestRecorder);
